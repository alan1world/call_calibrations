...
result = get_agent_details("Dominic Kessell")
print(result)
print(get_agent_details2("Dominic Kessell"))
print(get_pos_details2("Australia"))
print(get_agent_details3("Dominic Kessell"))
print(get_agent_details5("Dominic Kessell",agent_name="Dominic Kessell"))
print(get_agent_details5a("Dominic Kessell",agent_name="Dominic Kessell"))